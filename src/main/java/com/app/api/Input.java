...
public class Input {
    ...
    public static class KeyboardEvent {
         ...
         */
        public KeyboardEvent(int key, Type state, IState listener) {
            this.key = key;
            this.type = state;
         ...
         * @param listener The listener to be notified of state changes.
         */
        public KeyboardEvent(int key, IState listener) {
            this.key = key;
            this.listener = listener;
        ...
        public void setState(Type newState) {
            if (!this.getState().equals(newState)) {
                ...
                if ((this.getState().equals(this.type) || this.type.equals(Type.Default))) {
